...
class ShowStudentCourses extends StatefulWidget {
  @override
  ShowStudentCoursesState createState() => ShowStudentCoursesState();
}

class ShowStudentCoursesState extends State<ShowStudentCourses> {
...
//                                                right: new BorderSide(width: 1.0, color: Colors.white24))),
  ...
  Future getStudentCourses() async{
    ...
    String url = "http://10.0.2.2:3000/studentcourse/get/$userDetailsId";
